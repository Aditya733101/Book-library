...
if ($psw == $psw2) 
{
    $sql = "INSERT INTO `user` (`id`, `first_name`, `last_name`, `gender`, `dept`, `year`, `branch`, `username`, `tel`, `password`, `books`) VALUES (NULL, '$fname', '$lname', '$gender', '$dept', '$year', '$branch', '$uname', '$tel', '" . md5($psw) . "', '')";

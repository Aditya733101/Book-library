    ...
    <body class="d-flex flex-column h-100">
        ...
        <div class="containerr">
            ...
            <div class="containerr">
                ...
                <input type="password" placeholder="Enter Password" name="pws2" required>

                <label for="pws2"><b>Confirm Password</b></label>
                <input type="password" placeholder="Enter Password Again" name="pws2" required>
